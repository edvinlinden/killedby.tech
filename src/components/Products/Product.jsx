...
const GoogleLogo = () => (
	<div className={styles.logo} title="Google">
...
const AppleLogo = () => (
	<div className={styles.logo} title="Apple">
...
export default Product = ({ product }) => {
	const { name, dateOpen, dateClose, link, description, type, company } = product;
	...
	return (
		<div className={styles.product}>
			...
			<p className={styles.years} title={`${dateOpen} – ${dateClose}`}>
